...
<body class="bg-gradient-to-r from-green-200 to-blue-200">
    <div class="container mx-auto my-10">
        ...
        <form action="edit_profile.php" method="POST" enctype="multipart/form-data" class="bg-white/75 p-6 rounded-lg shadow-lg">
            ...
            <div class="mb-4 text-center">
                <div class="mb-2 relative inline-block">
                    ...
                    <div class="mb-4">
                        <label for="phone" class="block text-black font-bold mb-2">Phone Number:</label>
        ...
        <div class="mb-4">
            <label for="password" class="block text-black font-bold mb-2">New Password (optional):</label>
            <input type="password" id="password" name="password" class="w-full p-2 bg-white/75 border border-gray-300 rounded-md">
        </div>
        
        <div class="mb-4">
            <label for="password_confirm" class="block text-black font-bold mb-2">Confirm New Password:</label>
            <input type="password" id="password_confirm" name="password_confirm" class="w-full p-2 bg-white/75 border border-gray-300 rounded-md">
        </div>
