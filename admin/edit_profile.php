...
<body class="bg-gradient-to-r from-green-200 to-blue-200">
    <div class="container mx-auto my-10">
        ...
        <!-- Profile Form -->
        <form action="edit_profile.php" method="POST" enctype="multipart/form-data" class="bg-[#2D364C]/75 p-6 rounded-lg shadow-lg">
        ...
        <!-- Password Section -->
        <div class="mb-4">
            <label for="password" class="block text-white font-bold mb-2">New Password (optional):</label>
            <input type="password" id="password" name="password" class="w-full p-2 bg-white/75 border border-gray-300 rounded-md">
        </div>
        
        <!-- Confirm Password Section -->
        <div class="mb-4">
            <label for="password_confirm" class="block text-white font-bold mb-2">Confirm New Password:</label>
